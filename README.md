...
2)и версия на GPU с использованием CUDA  через библиотеку PyTorch.
...
Сравнение времени выполнения показало,  что для небольшой матрицы `100×100`  использование GPU оказалось невыгодным.  Это связано с тем, что накладные расходы  
на запуск вычислений и передачу данных  превышают выигрыш от параллельной обработки.
